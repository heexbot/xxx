...
client.on("message", message => {
 if (message.content === "-help") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('© heex Bot:heart: جميع الحقوق محفوظة 2017 لــبوت')
...
client.on("message", message => {
 if (message.content === "-invite") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('© heex Bot:heart: جميع الحقوق محفوظة 2017 لــبوت')
      .addField('شكراخدامك ل هييكس بوت', `https://discordapp.com/api/oauth2/authorize?client_id=440864078114586624&permissions=8&scope=bot`)
  message.author.send({embed});
